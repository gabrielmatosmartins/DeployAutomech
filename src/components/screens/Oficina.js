...
export function OficinaScreen() {
    ...
    async function getDadosOficina(id){
      ...
      let url = `https://4.227.162.137:443/Oficina/Detalhes/${id}`
    ...
    async function retornarVeiculos(id){
      const response = await fetch(`https://4.227.162.137:443/Cliente/${id}/Veiculo`, { method: 'GET' })
      var data = await response.json();
    ...
    async function retornarUmVeiculo(){
      ...
      const response = await fetch(`https://4.227.162.137:443/Veiculo/${idVeiculo}`, { method: 'GET' })
      var data = await response.json();
      return data;
    }

    async function fazerOrcamento(id){
      let url = `https://4.227.162.137:443/Orcamentos/Create`
