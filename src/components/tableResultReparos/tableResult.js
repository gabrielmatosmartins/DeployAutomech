...
export const TableResultReparos = () => {
    ...
    async function retornarOrcamentos(){
        const response = await fetch(`https://4.227.162.137:8080//Orcamentos/all`, { method: 'GET' })
    ...
    async function getReparos(){
        ...
        let url = `https://4.227.162.137:8080//Reparo/Pesquisar?idOrcamento=${idOrcamento}`
    ...
    async function finalizarReparos(){
        ...
        let url = `https://4.227.162.137:8080//Reparo/FinalizarReparo?idReparo=${inputsPost}`
